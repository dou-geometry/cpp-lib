...
namespace d {
    ...
    template Karabinerhaken<long int>* Karabinerhaken<long int>::after(long int);
    template Karabinerhaken<long long int>* Karabinerhaken<long long int>::after(long long int);
    template Karabinerhaken<unsigned short>* Karabinerhaken<unsigned short>::after(unsigned short);
